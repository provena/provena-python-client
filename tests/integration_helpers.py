...
valid_collection_format_1 = CollectionFormat(
    ...
    approvals=CollectionFormatApprovals(
        ...
        ethics_access=DatasetEthicsAccessCheck(relevant=True, obtained=False),
        indigenous_knowledge=IndigenousKnowledgeCheck(relevant=False, obtained=False),
        export_controls=ExportControls(relevant=True, obtained=False)
    ),
    dataset_info=CollectionFormatDatasetInfo(
        name="Dataset Variation 1",
        description="Integration test dataset variation 1",
        access_info=AccessInfo(reposited=False, uri="http://example.com/variation1", description="Variation 1 dataset"), #type:ignore
...
valid_collection_format_2 = CollectionFormat(
    ...
    approvals=CollectionFormatApprovals(
        ethics_registration=DatasetEthicsRegistrationCheck(relevant=False, obtained=True),
        ethics_access=DatasetEthicsAccessCheck(relevant=True, obtained=True),
        indigenous_knowledge=IndigenousKnowledgeCheck(relevant=True, obtained=False),
        export_controls=ExportControls(relevant=False, obtained=True)
    ),
    dataset_info=CollectionFormatDatasetInfo(
        name="Dataset Variation 2",
        description="Integration test dataset variation 2",
        access_info=AccessInfo(reposited=True, uri="http://example.com/variation2", description="Variation 2 dataset"),
        publisher_id="10378.1/1893860",  
...
valid_collection_format_3 = CollectionFormat(
    ...
    approvals=CollectionFormatApprovals(
        ethics_registration=DatasetEthicsRegistrationCheck(relevant=True, obtained=False),
        ethics_access=DatasetEthicsAccessCheck(relevant=False, obtained=False),
        indigenous_knowledge=IndigenousKnowledgeCheck(relevant=False, obtained=True),
    ...
    dataset_info=CollectionFormatDatasetInfo(
        ...
        access_info=AccessInfo(reposited=True, uri="http://example.com/variation3", description="Variation 3 dataset"), #type:ignore
        publisher_id="10378.1/1893860",
